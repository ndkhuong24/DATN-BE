...
//            @RequestParam(name = "amount") String amount, HttpServletRequest request
...
//        vnp_Params.put("vnp_Amount", String.valueOf(new BigDecimal(amount).multiply(new BigDecimal("100"))));
