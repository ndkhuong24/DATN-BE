...
public class AppConstant {
    ...
    public static final String[] API_VIEW_PERMIT = {
            ...
            "/view/api/cart",
            "/view/api/add-to-cart",
            "/view/api/giam-so-luong",
            "/view/api/tang-so-luong",
            "/view/api/xoa",
            "/view/api/get-cart-to-customer/*",
            "/view/api/create-payment",
            "/view/api/vnpay-payment",
