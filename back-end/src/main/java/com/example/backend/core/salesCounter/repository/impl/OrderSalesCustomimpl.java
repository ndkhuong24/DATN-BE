    ...
    public List<OrderAdminDTO> getAllOrderAdmin(OrderAdminDTO orderAdminDTO) {
        ...
        try {
            ...
            for (Object[] obj: lst) {
                ...
                dto.setCreateDate(createTimestamp != null ? createTimestamp.toLocalDateTime().toLocalDate() : null);
                Timestamp paymentTimestamp = (Timestamp) obj[6];
                dto.setPaymentDate(paymentTimestamp != null ? paymentTimestamp.toLocalDateTime().toLocalDate() : null);
                dto.setDeliveryDate((LocalDate) obj[7]);
                dto.setReceivedDate((LocalDate) obj[8]);
